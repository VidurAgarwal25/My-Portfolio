...
const ContactForm = () => {
  ...
  const onSubmit = async (formData) => {
    ...
    const formSubmitURL = `https://fabform.io/${process.env.NEXT_PUBLIC_FAB_FORM_KEY}`;
    try {
      ...
      toast({
        title:
          "There is some issue in sending your message. I wil be fixing it soon. Meanwhile, can you please connect with me over Email or Linkedin.",
        status: "error",
        position: "top",
